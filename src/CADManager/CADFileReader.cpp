...
vtkSmartPointer<vtkActor> Importing::CADFileReader::createVTKActor(TopoDS_Shape shape) {
...
std::string Importing::CADFileReader::getUniqueObjectName(std::string prefix) {
